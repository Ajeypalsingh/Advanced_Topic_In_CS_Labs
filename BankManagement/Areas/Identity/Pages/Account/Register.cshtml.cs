...
namespace BankManagement.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private BankUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(BankUser)}'. " +
                    $"Ensure that '{nameof(BankUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
